...
```
cd existing_repo
git remote add origin http://gitlab.sensorsdata.cn/sensors-deliver/vf/vf_sso.git
git branch -M master
...
- [ ] [Set up project integrations](http://gitlab.sensorsdata.cn/sensors-deliver/vf/vf_sso/-/settings/integrations)
